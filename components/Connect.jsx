  ...
  return (
    ...
    >
      <div className="max-w-[50%]">
        <h3 className="my-3 text-4xl text-text portrait:text-6xl">
          Let&apos;s Connect!
        </h3>
      ...
      <div className="relative h-60 w-60 max-w-[50%] overflow-clip rounded-md shadow-lg shadow-surface portrait:h-[25dvw] portrait:w-[25dvw] portrait:rounded-lg">
        <Image
